...
<body>
        ...
        <div class="container"><a class="navbar-brand logo" href="index.php">Spare Store</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navbarNav"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="choose.php">Sign-in</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <main class="page contact-page">
        <section class="portfolio-block contact" style="padding-top: 50px;padding-bottom: 50px;">
            <div class="container">
                <h2 class="text-center" style="margin-bottom: 25px">Choose an option</h2>
                
                <div class="row">
                    <div class="col text-right"><a class="btn btn-primary" role="button" href="signin-client.php" style="width: 150px;">As a client</a></div>
                    <div class="col"><a class="btn btn-primary" role="button" href="signin-seller.php" style="width: 150px;">As a seller</a></div>
                </div>
            </div>
        </section>
    </main>
